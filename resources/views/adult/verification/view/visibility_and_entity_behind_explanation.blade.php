        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p>Since the solution of a problem does not take outside element, to solve a problem we concern only about entities that enable us to solve that problem.  Anything that does not enable us to solve that problem, are putting behind us.  In other words, we simply left them, since they don’t help us solve the underlying problem.</p>
                    <p>Since the solution of a problem is natural, anything or item that can act as a disturbance to prevent us from solving that problem is not part of the solution.  In this case, we put such item behind us or think such item is not visible to us or does not exist.  In other words, we don’t put such item in front, we put it behind since it does not help us solving the problem. </p>
                    <p>Since the solution of a problem is natural and the solution of that problem is separate from us, it is always good for us to think only about entities that can be used to help us solve that problem, not entities that cannot help us solve that problem.  In this case, any other entities that does not help us solve that problem must be put behind</p>
                ...
                <div class="principleRelation mt-3">
                    ...
                    <div class="questionWrap">
                        ...
                        <ul style="list-style:none;">
                            <h5>To solve the problem, do you feel you have something you want to put behind you that will not help you in solving the problem? </h5>
                            <li><label><input type="radio"  name="validation_1" value="1" {{ (@$verification->validations->validation_1 == 1) ? 'checked' : '' }} >Yes, I do have things I want to put behind me that will not help solve the problem</label></li>
                            <li><label><input type="radio"  name="validation_1" value="2" {{ (@$verification->validations->validation_1 == 2) ? 'checked' : '' }} >No, I have nothing to put behind that will not help me solve the problem.</label></li>
                        </ul>
                        <ul style="list-style:none;">
                            <h5>Do you understand that the solution of a problem is given for that problem and does not include any outside entity that is not needed to solve that problem? </h5>
                            <li><label><input type="radio"  name="validation_2" value="1" {{ (@$verification->validations->validation_2 == 1) ? 'checked' : '' }} >Yes, I understand that the solution of a problem is given for that problem and does not include any outside entity that is not needed to solve that problem</label></li>
                            <li><label><input type="radio"  name="validation_2" value="2" {{ (@$verification->validations->validation_2 == 2) ? 'checked' : '' }} >No, I do not understand that the solution of a problem is given for that problem and does not include any outside entity that is not needed to solve that problem</label></li>
                        </ul>
