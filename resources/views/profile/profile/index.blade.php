...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            <div class="row">
                <form method="POST" action="{{ url("updateProfile") }}" class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30" enctype="multipart/form-data">
                    @csrf
                    <div class="pd-20 card-box height-100-p">
                        <div class="profile-photo">
                            <button type="button" id="chageAvatarBtn" class="edit-avatar"><i class="fa fa-pencil"></i></button>
                            <input type="file" style="display: none" id="changeAvatarInput" name="avatar">
                            <img src="{{ url("assets/vendors/images/avatar/" . Auth::user() -> avatar) }}" id="changeAvatarImg" alt="{{ Auth::user() -> name }}" class="avatar-photo">
                            <br>
                            @error('avatar')
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="input-group custom">
                                        <input type="text" class="form-control form-control-lg @error('name') form-control-danger @enderror" placeholder="Full Name" name="name" value="{{ Auth::user() -> name }}" required>            
                                ...
                                <li>
                                    ...
                                    <div class="input-group custom">
                                        <input type="text" class="form-control form-control-lg @error('email') form-control-danger @enderror" placeholder="Email" name="email" value="{{ Auth::user() -> email }}" required>
                                        <div class="input-group-append custom">
                                ...
                                <li>
                                    <button class="btn btn-success w-100 btn-block">Save change</button>
                                </li>
