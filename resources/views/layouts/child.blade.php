		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li>
						<a href="calendar.html" class="dropdown-toggle no-arrow {{ Route::is("adminHome") ? 'active' : '' }}">
					...
					<li>
						<a href="calendar.html" class="dropdown-toggle no-arrow {{ Route::is("adminHome") ? 'active' : '' }}">
							<span class="micon icon-copy dw dw-home"></span><span class="mtext">Share</span>
						</a>
					</li>
					<li>
						<a href="calendar.html" class="dropdown-toggle no-arrow {{ Route::is("adminHome") ? 'active' : '' }}">
							<span class="micon icon-copy dw dw-home"></span><span class="mtext">Quiz</span>
						</a>
					</li>
					<li>
						<a href="calendar.html" class="dropdown-toggle no-arrow {{ Route::is("adminHome") ? 'active' : '' }}">
							<span class="micon icon-copy dw dw-home"></span><span class="mtext">Setting</span>
						</a>
					</li>
				</ul>
			</div>
