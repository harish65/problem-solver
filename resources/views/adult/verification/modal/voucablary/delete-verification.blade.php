<!-- Modal Start -->
<div class="modal fade" id="deleteVerification" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" enctype="multipart/form-data">

<form method="POST" id="deleteVerificationForm"  enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="row">
                      <h3>Are you sure you want delete this Verification?</h3> 
                    </div>
                </div>
            </div>
