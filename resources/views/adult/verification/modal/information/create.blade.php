<!-- Modal Start -->
<div class="modal fade" id="createinfoVerification" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" enctype="multipart/form-data">

<form method="POST" id="InformationVerificationForm"  enctype="multipart/form-data">
    @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <select class="form-control" name="file" id="file">
                        ...
                        <option  data-src="{{ asset('assets-new/verification/voucablary/default-001.jpg')}}" value="1">Image One </option>
                        <option  data-src="{{ asset('assets-new/verification/voucablary/default-002.jpg')}}" value="2">Image Tow</option>
                </select>
                    <div class="image d-none"  id="default-image"style="margin: 20px;text-align: center;"></div>
                </div>
