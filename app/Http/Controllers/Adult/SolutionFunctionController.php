...
class SolutionFunctionController extends BaseController
{
    ...
    public function index($params = null)
    {
        ...
        $query = DB::table('solution_functions')
            ...
            ->select(
                'solution_functions.*',
                'solution_function_types.first_arr',
                'solution_function_types.second_arr',
                'solutions.id as solution_id',
                'solutions.name as solution_name',
                'solutions.file as solution_file',
                'solutions.created_at as solution_created',
                'solutions.type as solution_type',
                'problems.id as problem_id',
                'problems.name as problem_name',
                'problems.file as problem_file',
                'problems.project_id',
                'problems.type as problem_type',
