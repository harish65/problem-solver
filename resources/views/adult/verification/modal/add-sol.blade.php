<div class="modal fade" id="updateSolution" tabindex="-1" role="dialog" aria-labelledby="add-sol-modal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form id="updateSolutionForm" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" disabled name="problem" id="problem"  value="{{ $problem->name }}" class="form-control" placeholder="Problem *">
                        
                    </div>
                    <div class="form-group">
                        <input type="text" name="solutionName" id="solutionName" class="form-control" placeholder="Solution Name" value="{{ $solution->name }}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="btnUpadteSolution">Save changes</button>
                </div>
        </form>
    </div>
  </div>
