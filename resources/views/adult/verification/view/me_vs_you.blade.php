                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="imgWrp carousel-inner" role="listbox">
                                        ...
                                        <div class="carousel-item active"  >
                                            <img  src="{{ asset('assets-new/verification_types/meu/mu1.png')}}" alt="Chania" width="100%">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img  src="{{ asset('assets-new/verification_types/meu/mu2.png')}}" alt="Chania" width="100%">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img  src="{{ asset('assets-new/verification_types/meu/mu3.png')}}" alt="Chania" width="100%">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img  src="{{ asset('assets-new/verification_types/meu/mu4.png')}}" alt="Chania" width="100%">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img  src="{{ asset('assets-new/verification_types/meu/mu4.png')}}" alt="Chania" width="100%">
                                        </div>
                ...
                <div class="principleRelation mt-3">
                    ...
                    <div class="questionWrap">
                        ...
                        <ul style="list-style:none;">
                            ...
                            <li><label><input type="radio"  name="validation_1" value="1" {{ (@$verification->validations->validation_1 == 1) ? 'checked' : '' }} >No, I approach the solution of a problem like I work with you and people work together?</label></li>
                            <li><label><input type="radio"  name="validation_1" value="2" {{ (@$verification->validations->validation_1 == 2) ? 'checked' : '' }} >Yes, I approach the solution of a problem like me vs. you and people vs. people.</label></li>
                        </ul>
                        <ul style="list-style:none;">
                            <h5>Do I understand that to solve a problem is I work with and I don’t go against? </h5>
                            <li><label><input type="radio"  name="validation_2" value="1" {{ (@$verification->validations->validation_2 == 1) ? 'checked' : '' }} >Yes, I understand the solution of a problem is I work with and I don’t go against</label></li>
                            <li><label><input type="radio"  name="validation_2" value="2" {{ (@$verification->validations->validation_2 == 2) ? 'checked' : '' }} >No, I do not understand the solution of a problem is I work with and I don’t go against</label></li>
                        </ul>
